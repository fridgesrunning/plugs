...
namespace Ok1
{
    ...
    public class MultifilterTR : AsyncPositionedPipelineElement<IDeviceReport>
    {
        ...
        void StatUpdate(ITabletReport report)
        {
            ...
            if (frameShift > 0f) {
                ...
                if (tick > 90) {
                    sum1 += Vector2.DistanceSquared(h1, smpos[0]);
                    sum2 += Vector2.DistanceSquared(h2, smpos[0]);
               ...
               // Console.WriteLine(predict);
                if (ts != null) {
                    h1 = predict;
                    h2 = ts.Update2(smpos[0], secAvg, (hcToggle && (emergency > 0)));
                }
    ...
    public class KalmanFolk
    {
        ...
        public KalmanFolk(uint statesNumber, double initialPosition)
        {
            ...
            R2 = Matrix.Build.DenseDiagonal(3, 3, 0.0001);
        ...
        public double Update2(double measuredPos, double dt, bool nonconfident)
        {
            ...
            */
            ...
            var S = H2 * P * H2.Transpose() + R2 * 1.0;
